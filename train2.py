...
from model2_woLK import Model2
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.deep_model = Model2(dim=256, num_classes=50)
    ...
    def training(self):
        ...
        train_data_loader = DataLoader(
            OrgDataset("images", mode="train", size=(256, 256)),
    ...
    def validate(self):
        ...
        val_loader = DataLoader(
            OrgDataset("images", mode="val", size=(256, 256)),
            batch_size=self.args.batch_size,
            shuffle=False,
            pin_memory=True,
            num_workers=0,
